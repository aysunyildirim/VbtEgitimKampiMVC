...
namespace VbtEgitimKampiMVC.Infrastructure.Persistence.Repositories.Helper.Dynamic
{
        ...
        private static readonly IDictionary<string, string> _operators = new Dictionary<string, string>
    {
        ...
        private static IQueryable<T> Sort<T>(IQueryable<T> queryable, IEnumerable<Sort> sort)
        {
            ...
            if (sort.Any())
            {
                string ordering = string.Join(separator: ",", values: sort.Select(s => $"{ToUpperCase(s.Field)} {s.Dir}"));
        ...
        public static string Transform(Filter filter, IList<Filter> filters)
        {
            ...
            filter.Field = ToUpperCase(filter.Field);
        ...
        private static string ToUpperCase(string input)
        {
            ...
            return input.ToUpper(CultureInfo.GetCultureInfo("en-US")); // Alan adlarını büyük harfe çevir
        }
